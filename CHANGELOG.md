...
## [0.6.0](https://github.com/mufeedali/flatplay/compare/v0.5.0...v0.6.0) - 2026-02-15
...
- [**breaking**] Add manifest hash checking (Triggers a rebuild in existing projects)

### Other

- *(deps)* bump actions/checkout from 5 to 6 ([#39](https://github.com/mufeedali/flatplay/pull/39))
- upgrade serde-saphyr
